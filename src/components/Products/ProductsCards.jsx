...
const ProductsCards = ({ product, index }) => {
  return (
    <div key={index} className="bg-white p-4 rounded-xl">
      ...
      >
        <div className="absolute top-0 left-0 w-full h-full bg-neutral-950/40 z-40 scale-0 group-hover/image:scale-100 transition-all duration-200">
          <div className="z-50 flex items-center justify-center h-full text-white text-center">
            <p className="border-2 border-white w-32 bg-neutral-950/70 aspect-square flex items-center justify-center rounded-full  cursor-pointer">
              View <br /> Product
            </p>
          </div>
        </div>
